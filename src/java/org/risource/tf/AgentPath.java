// AgentPath.java
// $Id: AgentPath.java,v 1.3 2001-04-03 00:05:27 steve Exp $
...
public final class AgentPath extends Agent {

  /**
   * Get an agent's path in a request URL.
   * @param name A transaction 
