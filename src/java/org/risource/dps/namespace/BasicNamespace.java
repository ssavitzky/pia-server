...
//	$Id: BasicNamespace.java,v 1.8 2001-04-03 00:04:37 steve Exp $
 ...
 *
 *
 * @version $Id: BasicNamespace.java,v 1.8 2001-04-03 00:04:37 steve Exp $
...
public class BasicNamespace extends AbstractNamespace {
  ...
  ************************************************************************/
  ...
  public BasicNamespace(String tag, String name, ActiveAttrList attrs) {
    super(tag, name);
    attrList = attrs;
  }
