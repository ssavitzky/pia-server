...
//	$Id: ifHandler.java,v 1.10 2001-01-11 23:37:20 steve Exp $
 ...
 *	<p>
 *
 * @version $Id: ifHandler.java,v 1.10 2001-01-11 23:37:20 steve Exp $
  ...
  ************************************************************************/
  ...
  public boolean processConditional(Input in, Context aContext, Output out,
	...
	if (cl == thenHandlerClass) {
	  ...
	  if (Test.trueValue(child, aContext)) trueCondition = true;
	}
