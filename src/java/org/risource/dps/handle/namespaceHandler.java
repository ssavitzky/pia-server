...
//	$Id: namespaceHandler.java,v 1.10 2001-04-03 00:04:28 steve Exp $
 ...
 *
 * @version $Id: namespaceHandler.java,v 1.10 2001-04-03 00:04:28 steve Exp $
...
public class namespaceHandler extends GenericHandler {
  ...
  ************************************************************************/
  ...
  protected Namespace makeNamespace(Context cxt, String tag, String name,
				    ActiveAttrList atts) {
    return new BasicNamespace(tag, name, atts);
  }
