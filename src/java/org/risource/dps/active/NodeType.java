...
//	$Id: NodeType.java,v 1.7 2001-01-11 23:37:13 steve Exp $
 ...
 *
 * @version $Id: NodeType.java,v 1.7 2001-01-11 23:37:13 steve Exp $
...
public class NodeType {
  ...
  public static short getType(String name) {
    for (short i = 0; i < names.length; ++i) 
      if (name.equalsIgnoreCase(names[i])) return ((short)(i + MIN_TYPE));
    return UNDEFINED;
  }
