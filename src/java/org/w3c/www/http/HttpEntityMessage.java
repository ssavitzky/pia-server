...
// $Id: HttpEntityMessage.java,v 1.1 1999-03-12 19:50:55 pgage Exp $  
...
public class HttpEntityMessage extends HttpMessage {
    ...
    public static int H_ALLOW               = 15;
    public static int H_CONTENT_LENGTH      = 16;
    public static int H_CONTENT_BASE        = 17;
    public static int H_CONTENT_ENCODING    = 18;
    public static int H_CONTENT_LANGUAGE    = 19;
    public static int H_CONTENT_LOCATION    = 20;
    public static int H_CONTENT_MD5         = 21;
    public static int H_CONTENT_RANGE       = 22;
    public static int H_CONTENT_TYPE        = 23;
    public static int H_ETAG                = 24;
    public static int H_EXPIRES             = 25;
    public static int H_LAST_MODIFIED       = 26;
