...
// $Id: HttpRequestMessage.java,v 1.1 1999-03-12 19:51:13 pgage Exp $
...
public class HttpRequestMessage extends HttpEntityMessage {
    ...
    public static int H_ACCEPT              = 27;
    public static int H_ACCEPT_CHARSET      = 28;
    public static int H_ACCEPT_ENCODING     = 29;
    public static int H_ACCEPT_LANGUAGE     = 30;
    public static int H_AUTHORIZATION       = 31;
    public static int H_EXPECT              = 32;
    public static int H_FROM                = 33;
    public static int H_HOST                = 34;
    public static int H_IF_MODIFIED_SINCE   = 35;
    public static int H_IF_MATCH            = 36;
    public static int H_IF_NONE_MATCH       = 37;
    public static int H_IF_RANGE            = 38;
    public static int H_IF_UNMODIFIED_SINCE = 39;
    public static int H_MAX_FORWARDS        = 40;
    public static int H_PROXY_AUTHORIZATION = 41;
    public static int H_RANGE               = 42;
    public static int H_REFERER             = 43;
    public static int H_TE                  = 44;
    public static int H_USER_AGENT          = 45;
