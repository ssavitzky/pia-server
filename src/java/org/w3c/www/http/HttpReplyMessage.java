...
// $Id: HttpReplyMessage.java,v 1.1 1999-03-12 19:51:11 pgage Exp $
...
public class HttpReplyMessage extends HttpEntityMessage {
    ...
    public static int H_ACCEPT_RANGES       = 46;
    public static int H_AGE                 = 47;
    public static int H_LOCATION            = 48;
    public static int H_PROXY_AUTHENTICATE  = 49;
    public static int H_PUBLIC              = 50;
    public static int H_RETRY_AFTER         = 51;
    public static int H_SERVER              = 52;
    public static int H_VARY                = 53;
    public static int H_WARNING             = 54;
    public static int H_WWW_AUTHENTICATE    = 55;
