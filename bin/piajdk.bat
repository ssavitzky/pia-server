@echo off
REM a batch script to start the pia on win95/NT in a dos box using a JDK
...
echo Running java org.risource.pia.Pia -home %PIAHOME% -root %UHOME%
java org.risource.pia.Pia -home %PIAHOME% -root %UHOME%
